...
(function(global, factory) {
  ...
  function initMixin(BScroll) {
    ...
    BScroll.prototype._watchTransition = function() {
      ...
      Object.defineProperty(this, key, {
        ...
        set: function set(newVal) {
          ...
          // fix issue #359
          var el = me.scroller.children.length
    ...
    BScroll.prototype._shouldNotRefresh = function() {
      ...
      return (
        this.isInTransition || this.stopFromTransition || outsideBoundaries
      );
    };
    ...
    BScroll.prototype._translate = function(x, y, scale) {
      ...
      if (this.options.wheel) {
        var _options$wheel$rotate = this.options.wheel.rotate,
          rotate =
            _options$wheel$rotate === undefined ? 25 : _options$wheel$rotate;
  ...
  function snapMixin(BScroll) {
    BScroll.prototype._initSnap = function() {
      ...
      this.on('refresh', function() {
        ...
        _this._goToPage(
          _this.currentPage.pageX || initPageX,
          _this.currentPage.pageY || initPageY,
          0
        );
        ...
        if (snapThreshold % 1 === 0) {
          ...
          _this.snapThresholdX = Math.round(
            _this.pages[_this.currentPage.pageX][_this.currentPage.pageY]
              .width * snapThreshold
          );
        ...
        if (snap.loop) {
          if (snap._loopX) {
            if (_this.currentPage.pageX === 0) {
              _this._goToPage(
                _this.pages.length - 2,
                _this.currentPage.pageY,
                0
              );
            }
            ...
            if (_this.currentPage.pageY === 0) {
              _this._goToPage(
                _this.currentPage.pageX,
                _this.pages[0].length - 2,
                0
              );
            }
  ...
  function scrollbarMixin(BScroll) {
    BScroll.prototype._initScrollbar = function() {
      ...
      var _options$scrollbar = this.options.scrollbar,
        ...
        fade =
          _options$scrollbar$fa === undefined ? true : _options$scrollbar$fa,
        _options$scrollbar$in = _options$scrollbar.interactive,
        interactive =
          _options$scrollbar$in === undefined ? false : _options$scrollbar$in;
  ...
  Indicator.prototype.updatePosition = function() {
    if (this.direction === 'vertical') {
      ...
      if (this.scroller.options.useTransform) {
        this.indicatorStyle[style.transform] =
          'translateY(' + y + 'px)' + this.scroller.translateZ;
      } else {
      ...
      if (this.scroller.options.useTransform) {
        this.indicatorStyle[style.transform] =
          'translateX(' + x + 'px)' + this.scroller.translateZ;
      } else {
  ...
  Indicator.prototype._end = function(e) {
    ...
    if (snapOption) {
      var speed = snapOption.speed,
        ...
        easing =
          _snapOption$easing === undefined ? ease.bounce : _snapOption$easing;
  ...
  function pullDownMixin(BScroll) {
    ...
    BScroll.prototype._checkPullDown = function() {
      var _options$pullDownRefr = this.options.pullDownRefresh,
        ...
        threshold =
          _options$pullDownRefr2 === undefined ? 90 : _options$pullDownRefr2,
        _options$pullDownRefr3 = _options$pullDownRefr.stop,
        stop =
          _options$pullDownRefr3 === undefined ? 40 : _options$pullDownRefr3;
  ...
  function pullUpMixin(BScroll) {
    ...
    BScroll.prototype._checkToEnd = function(pos) {
      ...
      var _options$pullUpLoad$t = this.options.pullUpLoad.threshold,
        threshold =
          _options$pullUpLoad$t === undefined ? 0 : _options$pullUpLoad$t;

      if (
        this.movingDirectionY === DIRECTION_UP &&
        pos.y <= this.maxScrollY + threshold
      ) {
  ...
  function mouseWheelMixin(BScroll) {
    ...
    BScroll.prototype._onMouseWheel = function(e) {
      ...
      var _options$mouseWheel = this.options.mouseWheel,
        ...
        speed =
          _options$mouseWheel$s === undefined ? 20 : _options$mouseWheel$s,
        _options$mouseWheel$i = _options$mouseWheel.invert,
        invert =
          _options$mouseWheel$i === undefined ? false : _options$mouseWheel$i,
        _options$mouseWheel$e = _options$mouseWheel.easeTime,
        easeTime =
          _options$mouseWheel$e === undefined ? 300 : _options$mouseWheel$e;
      ...
      this.movingDirectionX = this.directionX =
        wheelDeltaX > 0 ? -1 : wheelDeltaX < 0 ? 1 : 0;
      this.movingDirectionY = this.directionY =
        wheelDeltaY > 0 ? -1 : wheelDeltaY < 0 ? 1 : 0;
  ...
  function zoomMixin(BScroll) {
    ...
    BScroll.prototype._zoomTo = function(scale, originX, originY, startScale) {
      ...
      var newX = Math.round(
        this.startX - (originX - this.relativeX) * (lastScale - 1)
      );
      var newY = Math.round(
        this.startY - (originY - this.relativeY) * (lastScale - 1)
      );
    ...
    BScroll.prototype._zoomStart = function(e) {
      ...
      this.originX =
        Math.abs(firstFinger.pageX + secondFinger.pageX) / 2 + left - this.x;
      this.originY =
        Math.abs(firstFinger.pageY + secondFinger.pageY) / 2 + top - this.y;
  ...
  InfiniteScroller.prototype.onScroll = function() {
    ...
    var lastScreenItem = this._calculateAnchoredItem(
      this.anchorItem,
      this.wrapperEl.offsetHeight
    );
  ...
  InfiniteScroller.prototype._createDOMNodes = function(unusedNodes) {
    ...
    for (var i = this.firstAttachedItem; i < this.lastAttachedItem; i++) {
      ...
      if (currentNode) {
        if (isTombstoneNode(currentNode) && currentData) {
          ...
          tombstoneAnimations[i] = [
            currentNode,
            this.items[i].top - this.anchorScrollTop
          ];
          this.items[i].node = null;
        } else {
          continue;
      ...
      var node = currentData
        ? this.options.render(currentData, unusedNodes.pop())
        : this._getTombStone();
  ...
  InfiniteScroller.prototype._setupAnimations = function(
    tombstoneAnimations,
    curPos
  ) {
    var _this3 = this;
    ...
    for (var i in tombstoneAnimations) {
      ...
      this.items[i].node.style.transform =
        'translateY(' +
    ...
    for (var _i2 = this.firstAttachedItem; _i2 < this.lastAttachedItem; _i2++) {
      ...
      if (_animation) {
        ...
        tombstoneNode.style.transition =
          'transform ' +
          ANIMATION_DURATION_MS +
          'ms, opacity ' +
          ANIMATION_DURATION_MS +
          'ms';
        tombstoneNode.style.transform =
          'translateY(' +
          curPos +
          'px) scale(' +
    ...
    this.scroller.maxScrollY = -(
      curPos -
      this.wrapperEl.offsetHeight +
      (this.hasMore ? DEFAULT_SCROLL_RUNWAY : 0)
    );
  ...
  InfiniteScroller.prototype._calculateAnchoredItem = function(
    initialAnchor,
    delta
  ) {
    if (delta === 0) {
    ...
    if (delta < 0) {
      ...
      tombstones = Math.max(
        -i,
        Math.ceil(Math.min(delta, 0) / this.tombstoneHeight)
      );
    } else {
      while (
        delta > 0 &&
